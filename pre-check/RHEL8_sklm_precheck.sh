...
typeset Log_File="RHEL8_sklm_precheck_${HOSTNAME}_${Current_Date_And_Time}.log"
typeset firewallRules="/tmp/RHEL_sklm_precheck_${HOSTNAME}_${Current_Date_And_Time}.iptable.rules"
...
echo saving current firewallrules to file: \"$firewallRules\"
...
echo
echo =====================================
echo checking mount point tmp for noexec flag
echo =====================================
echo
...
echo
echo "required settings in /etc/sysctl.conf"
...
echo =====================================
echo
echo grep sklm /etc/services
grep -e sklmdb /etc/services
echo
echo
echo
...
echo =====================================
echo
echo grep -e sklm -e klmfcusr /etc/passwd
grep -e sklm -e klmfcusr /etc/passwd
echo
echo getent passwd | grep -e sklm -e klmfuser
getent passwd | grep -e sklm -e klmfuser
echo
echo
